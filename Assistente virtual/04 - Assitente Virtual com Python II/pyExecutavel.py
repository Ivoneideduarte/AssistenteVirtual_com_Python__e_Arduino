'''
Prompt de comando: pip install PyInstaller - Gera executáveis no PC
                   cd D:\Meus arquivos principais\CURSOS\Lista de Cursos\Curso de Robótica - Escola Pixels\Assistente virtual com Python e Arduino\04 - Assitente Virtual com Python II - Coloca o caminho do arquivo que será convertido para .exe
'''
